...
const nameRules = {required: true, message: "please input you name"};
const passwordRules = {required: true, message: "please input you password"};
    ...
    return (
      <div>
        ...
        {getFieldDecorator("password", {rules: [passwordRules]})(
          <input type="password" placeholder="please input you password" />
        )}
